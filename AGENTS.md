...
- **This is an owner-approved public repository.** Its GitHub visibility is public by owner decision, so agents must not describe it as private or confidential. Changing GitHub visibility remains an owner-only decision: never make it private, public, or otherwise change visibility without explicit owner approval.
